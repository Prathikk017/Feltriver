...
// import { TiSpcialPinterest } from 'react-icons/ti';
  ...
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
      ...
      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4'>2023 Feltriver, LLC. All rights reserved</p>
        <div className='flex justify-between sm:w-[300px] pt-4 px-4 text-2xl'>
          <FaFacebook/>
          <FaInstagram/>
          <FaTwitter/>
        </div>
